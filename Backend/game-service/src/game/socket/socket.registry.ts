...
export class SocketRegistry {
	...
	public addConnection(socket: WebSocket, socketId: string, userId?: string): UserConnection {
	...
	public removeConnection(socketId: string): void {
		...
		if (connection) {
			if (connection.userId) {
				// Only remove if it matches (handle race conditions)
			...
			// Clean up room/tournament associations
