		...
		this.innerHTML = `
			<div class="space-y-8">
				...
				${isGoogleUser ? `
					...
					<div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl border-2 border-blue-200 dark:border-blue-700">
						<div class="flex items-start gap-4">
							...
							<div class="flex-1">
								<h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">${t("security_settings_google_account_title")}</h3>
								<p class="text-sm text-gray-700 dark:text-gray-300 mb-3">${t("security_settings_google_account_description")}</p>
