function createErrorPage(errorCode : string, title:string, desc:string ):string
{
	return (
...
export const ErrorPages = {
	notFound: () => createErrorPage("404", "Page Not Found", "The page you are looking for does not exist"),
	serverError: () => createErrorPage("500", "Server Error", "An error has occurred"),
	general: () => createErrorPage("!", "Error", "Something went wrong")
};